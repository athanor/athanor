...
struct OpPower : public SimpleBinaryOperator<IntView, IntView,IntView, OpPower> {
    using SimpleBinaryOperator<IntView, IntView,IntView, OpPower>::SimpleBinaryOperator;
